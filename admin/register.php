...
if (isset($_POST['register'])) {
	...
	//checking user from database if details matches or not
			...
			if (mysqli_num_rows($check_username) == 0) {
				if (strlen($username) > 7) {
					if (strlen($password) > 7) {
						...
						$passlan = "This password has more than 8 charset";
					}
				} else {
					$usernamelan = 'This username has more than 8 charset';
				}
			} else {
...
<body>
	...
	<p style="text-align:center;margin-top:20px">If you have account, you can <a href="login.php">Login</a> with your account!</p>
	</div>
