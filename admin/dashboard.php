...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-user"></i> &nbsp Dashboard</li>
  </ol>
</nav>
...
<div class="row student">
  ...
  <!--For admin/current user welcome card-->
  <div class="col-sm-4">
      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <div style="font-size: 20px, text-alignment:initial"><?php echo ucwords($userrow['name']); ?></div>
          </div>
          <div class="col-sm-6">
...
<hr>
<h3>New Students</h3>
<!--Table for overview of students enrooled newly-->
<table class="table  table-striped table-hover table-bordered" id="data">
  ...
  <tbody>
    <!--Setting table and retrieving info from data-->
    <?php
    ...
    while ($result = mysqli_fetch_array($query)) { ?>
      <tr>
        ...
        echo '<td>' . $i . '</td>
          ...
          <td><img src="images/' . $result['photo'] . '" height="70px"></td>'; ?>
      </tr>
    <?php $i++;
    } ?>
